...
plot "lenet_train.log.train" using 1:4 title "train loss"
replot "lenet_train.log.test" using 1:5 title "test loss"
replot "lenet_train.log.test" using 1:4 title "test accuracy"
